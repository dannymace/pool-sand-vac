...
- Orientation: flat skid on build plate, model centered on X1C bed; expected bounds are about `185 x 85 x 79 mm`
...
- Do not use Bambu Studio auto-orient for this part. If it stands the part upright at about `185 mm` tall with the exhaust barb vertical, undo that change and return to skid-down orientation.
